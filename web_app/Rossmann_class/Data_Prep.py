...
class Data_Prep(object):
    ...
    def __init__(self):
        self.competition_distance_scaler   = pickle.load(open('encoders/competion_distance_scaler.pkl', 'rb')) # Opening scaler
        self.competition_time_month_scaler = pickle.load(open('encoders/competition_time_month_scaler.pkl', 'rb')) # Opening scaler
        self.year_scaler                   = pickle.load(open('encoders/year_scaler.pkl', 'rb')) # Opening scaler
        self.promo2_time_week_scaler       = pickle.load(open('encoders/promo2_time_week_scaler.pkl', 'rb')) # Opening scalers
        self.store_type_encoder            = pickle.load(open('encoders/store_type_encoder.pkl', 'rb')) # Opening encoders
        
        self.df_store                      = pd.read_csv('store/store.csv')
